...
export class UserFormComponent {
  userForm = new FormGroup({
    ...
    address: new FormGroup({
      ...
      suite: new FormControl(undefined, {
    ...
    company: new FormGroup({
      ...
      catchPhrase: new FormControl(undefined, {
        validators: [Validators.maxLength(500)],
      }),
      bs: new FormControl(undefined, {
  ...
  async submitForm() {
    const userFromForm: NewUser = {
      ...
      address: {
        ...
        geo: {
          lat:
            this.userForm.controls.address.controls.geo.controls.lat.value ??
            undefined,
          lng:
            this.userForm.controls.address.controls.geo.controls.lng.value ??
            undefined,
        },
      },
      ...
      company: {
        ...
        catchPhrase:
          this.userForm.controls.company.controls.catchPhrase.value ??
          undefined,
    ...
    await firstValueFrom(
      this.userService.createUser(userFromForm).pipe(
        catchError((err) => {
